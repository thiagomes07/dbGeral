<?php
    ...
    $cidades = $select->select("SELECT Cidade FROM tbcidade");
?>
    ...
    <body>
        ...
        <main>
            ...
            <section>
                <article>
                    <div class="box">
                        <form action="php/endereco_submit.php" method="POST">
                            <fieldset>
                                <legend><strong>Endereço</strong></legend>
                                <div class="inputBox">
                                    <input type="text" name="Logradouro" id="Logradouro" class="inputUser" maxlength="120" required>
                                    <label for="Logradouro" class="labelInput">Logradouro</label>
                                </div>
                                <div class="inputBox">
                                    <input type="text" name="Cidade" id="Cidade" class="inputUser" maxlength="80" list="cidades" required>
                                    <datalist id="cidades">
