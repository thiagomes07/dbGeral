                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href="deletar-submit/deletar-endereco-funcionario-submit.php?id=<?= aes_encriptar($endereco['FuncionarioId'])?>" class="imgdel"><img src="../../images/deletar-peq.png" alt="ícone de Cadastro" class="icone_botao_peq"></a>
                                    </td>
                                    <td>
                                        <?= $endereco['Nome']?>
                                    </td>
