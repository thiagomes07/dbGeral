<?php
    ...
    $delete->delete("DELETE FROM tbCliente WHERE `ClienteId`=:ClienteId", [
...
<html lang="pt-br">
    ...
    <body>
        ...
        <main>
            <div class="centro">
                <h1 id="sucesso"><?= $erro == 1 ? 'Não foi possível deletar. Este cliente participou de uma venda' : 'Cliente deletado com sucesso!'?></h1>
