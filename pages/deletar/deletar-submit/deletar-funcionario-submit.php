<?php
    ...
    $delete->delete("DELETE FROM tbFuncionario WHERE `FuncionarioId`=:FuncionarioId", [
...
<html lang="pt-br">
    ...
    <body>
        ...
        <main>
            <div class="centro">
                <h1 id="sucesso"><?= $erro == 1 ? 'Não foi possível deletar. Este funcionário participou de uma venda' : 'Funcionário deletado com sucesso!'?></h1>
