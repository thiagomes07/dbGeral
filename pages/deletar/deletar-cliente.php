                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href="deletar-submit/deletar-cliente-submit.php?id=<?= aes_encriptar($cliente['ClienteId'])?>" class="imgdel"><img src="../../images/deletar-peq.png" alt="ícone de Cadastro" class="icone_botao_peq"></a>
                                    </td>
                                    <td>
                                        <?= $cliente['Nome']?>
                                    </td>
