<?php
    ...
    if(isset($_POST['Cep'])){
        ...
        // Consulta sem filtro:
        $enderecos = $select->select("SELECT * FROM tbEndereco INNER JOIN tbCidade ON tbEndereco.CidadeId = tbCidade.CidadeId
        INNER JOIN tbEstado ON tbCidade.EstadoId = tbEstado.EstadoId ORDER BY Estado, Logradouro");
    } 
?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href="deletar-submit/deletar-endereco-submit.php?cep=<?= $endereco['Cep']?>" class="imgdel"><img src="../../images/deletar-peq.png" alt="ícone de Cadastro" class="icone_botao_peq"></a>
                                    </td>
                                    <td>
                                        <?= $endereco['Estado']?>
                                    </td>
