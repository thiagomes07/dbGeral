                                ...
                                <?php foreach ($enderecos as $endereco) : ?>
                                    <tr>
                                        <td>
                                            ...
                                            <a href="atualizar-formulario/atualizar-endereco-cliente-formulario.php?id=<?= aes_encriptar($endereco['ClienteId']) ?>" class="img"><img src="../../images/atualizar-peq.png" alt="ícone de Cadastro" class="icone_botao_peq"></a>
                                        </td>
                                        <td>
                                            <?= $endereco['Nome'] ?>
                                        </td>
