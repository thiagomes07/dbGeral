<?php
    ...
    if(empty(trim($_POST['NumeroEnderecoFuncionario']))){
    ...
    $update->update("UPDATE tbFuncionario SET NumeroEndereco = :NumeroEndereco, Cep = :CepFuncionario WHERE FuncionarioId = :FuncionarioId", [
    ...
    <body>
        ...
        <main>
            <div class="centro">
                ...
                <p><a href="../../atualizar-endereco-funcionario.php" class="voltar">Voltar</a></p>
            </div>
        </main>
