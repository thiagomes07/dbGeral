                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href="atualizar-formulario/atualizar-funcionario-formulario.php?id=<?= aes_encriptar($funcionario['FuncionarioId'])?>" class="img"><img src="../../images/atualizar-peq.png" alt="ícone de Cadastro" class="icone_botao_peq"></a>
                                    </td>
                                    <td>
                                        <?= $funcionario['Nome']?>
                                    </td>
