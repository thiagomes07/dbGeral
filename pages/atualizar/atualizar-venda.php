                                ...
                                <?php foreach ($vendas as $venda) : ?>
                                    <tr>
                                        <td>
                                            ...
                                            <a href="atualizar-formulario/atualizar-venda-formulario.php?id=<?= aes_encriptar($venda['NfIdVenda'])?>" class="img"><img src="../../images/atualizar-peq.png" alt="ícone de Cadastro" class="icone_botao_peq"></a>
                                        </td>
                                        <td>
