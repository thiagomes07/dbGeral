                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href="atualizar-formulario/atualizar-cliente-formulario.php?id=<?= aes_encriptar($cliente['ClienteId'])?>" class="img"><img src="../../images/atualizar-peq.png" alt="ícone de Cadastro" class="icone_botao_peq"></a>
                                    </td>
                                    <td>
                                        <?= $cliente['Nome']?>
                                    </td>
